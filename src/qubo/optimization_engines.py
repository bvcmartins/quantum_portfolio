...
def genetic_algorithm_qubo(data, population_size=500, num_generations=100, mutation_rate=0.1, elitism=0.1, max_weight=None):
    """
...
def scipy_slsqp_qubo(data, max_weight=None):
    """
...
def riskfolio_qubo(data, max_weight=None):
    """
...
def dwave_cqm_qubo(data, budget=1000000.0, max_weight=None):
    """
    ...
    results = sampler.sample_cqm(cqm, time_limit=20, label="Portfolio_Optimization_D-Wave_CQMSampler")
